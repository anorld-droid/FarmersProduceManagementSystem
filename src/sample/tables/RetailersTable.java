...
public class RetailersTable {
    ...
    public TableView<Retailers> Retailers() throws IOException {
        ...
        TableColumn<Retailers, Integer> phoneNumber = new TableColumn<>("Phone Number");
        phoneNumber.setCellValueFactory(new PropertyValueFactory<>("phoneNumber"));
        TableColumn<Retailers, String> products = new TableColumn<>("Products");
        products.setCellFactory(TextFieldTableCell.forTableColumn());
    ...
    private ArrayList dataBaseArrayList(ResultSet resultSet) throws  SQLException{
        ...
        while (resultSet.next()){
           Retailers retailers = new Retailers();
            retailers.id.set(id);
            retailers.firstName.set(resultSet.getString("firstName").toUpperCase());
            retailers.lastName.set(resultSet.getString("lastName").toUpperCase());
            retailers.phoneNumber.set(resultSet.getInt("phoneNumber"));
            retailers.products.set(resultSet.getString("Name").toUpperCase());
            retailers.amount.set(resultSet.getInt("amount"));
            retailers.unit.set(resultSet.getString("unit").toUpperCase());
